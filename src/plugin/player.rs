use crate::{
    data::{LAYER_ACTOR_PLAYER, WORLD_SIZE_HALF}, plugin::{
        Actor, ActorAction, ActorActions, ActorActionsExt, ActorConfig, ActorSet, Crosshair, Health, Heartbeat, StatusBar, WeaponConfig, WeaponSet, camera::MainCamera, camera_target::CameraTarget, kinetics::Kinetics,
    }, resource::Settings, state::AppState, util::ext::{AppExt, QuatExt, Vec2Ext},
};
use bevy::{
    camera::Camera,
    ecs::{
